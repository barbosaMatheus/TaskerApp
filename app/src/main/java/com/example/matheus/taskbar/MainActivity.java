...
public class MainActivity extends AppCompatActivity {
    ...
    public final String help_message = "Welcome, and thank you for downloading Tasker!" +
            ...
            "issues please send an e-mail to asaph@okstate.edu.";
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        /*Toast.makeText( this, Integer.toString( size_1 ) + " " + Integer.toString( size_3 ),
        ...
        tasks = ( Button ) this.findViewById( R.id.tasks_button );
    ...
    public void show_edit_pop_up( final int button ) {
        ...
        if( button == 1 ) edit.setText( custom_list1_label );
        else if( button == 2 ) edit.setText( custom_list2_label );
    ...
    public void button_click_listener( View view ) {
        if( view == this.findViewById( R.id.tasks_button ) ) { //if tasks is pressed
            ...
            intent.putExtra( "title", custom_list1_label );
            ...
            intent.putExtra( "title", custom_list2_label );
    ...
    public void update_buttons( ) {
        SharedPreferences g_file = PreferenceManager.getDefaultSharedPreferences( this );     //make shared preferences object
        final int size_1 = g_file.getInt( "size", 0 );
        final int size_3 = g_file.getInt( "size3", 0 );
        final int size_4 = g_file.getInt( "size4", 0 );

        final String label_1 = custom_list1_label + ( size_3 > 0 ? " (" + Integer.toString( size_3 ) + ")" : "" );
        list1.setText( label_1 );

        final String label_2 = custom_list2_label + ( size_4 > 0 ? " (" + Integer.toString( size_4 ) + ")" : "" );
        list2.setText( label_2 );

        final String label_tasks = "Tasks" + ( size_1 > 0 ? " (" + Integer.toString( size_1 ) + ")" : "" );
        tasks.setText( label_tasks );
    }
